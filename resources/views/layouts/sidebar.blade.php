    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="left-menu list-unstyled" id="side-menu">
                ...
                <li><a href="{{ route('vista_ambientes') }}"><i class="fa fa-building"></i> <span>Ambientes</span></a></li>
                <li><a href="{{ route('vista_planificar') }}"><i class="fa fa-calendar-check"></i> <span>Planificar horario</span></a></li>
                <li><a href="{{ route('asignar_horarios') }}"><i class="fa fa-calendar-plus"></i> <span>Asignar horarios</span></a></li>
